...
final _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/paso3',
      builder: (_, __) => const PantallaTemporal(titulo: 'Paso 3 · API real'),
    ),
    ...
    GoRoute(
      path: '/paso4',
      builder: (_, __) =>
          const PantallaTemporal(titulo: 'Paso 4 · Errores tipados'),
    ),
    ...
    GoRoute(
      path: '/paso5',
      builder: (_, __) =>
          const PantallaTemporal(titulo: 'Paso 5 · Arquitectura completa'),
    ),
  ],
);
