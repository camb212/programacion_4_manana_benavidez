              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Chip(
                      label: Text(
                          '${reservas.where((t) => t.completed).length} devueltos'), 
                      backgroundColor: Colors.green[100],
                    ),
                    const SizedBox(width: 8),
                    Chip(
                      label: Text(
                          '${reservas.where((t) => !t.completed).length} en alquiler'), 
