...
import '../models/dispositivo_mp.dart';
import '../widgets/chip_resumen_mp.dart';
import '../widgets/fila_dispositivo_mp.dart';
  ...
  Widget build(BuildContext context) {
    final dispositivos = [
      const InfoDispositivo(
        ...
        ruta: '10.0.0.1', activo: true, alertas: 2,
        etiquetas: ['BGP', 'OSPF', 'Gateway'],
      ),
      const InfoDispositivo(
        nombre: 'sw-distribucion', tipo: 'switch',
        ruta: '10.0.1.1', activo: true, alertas: 0,
        etiquetas: ['L3', 'VLAN 10', 'VLAN 20'],
      ),
      const InfoDispositivo(
        nombre: 'Bus-01', tipo: 'server',
        ruta: 'Ruta 42', activo: true, alertas: 1,
        etiquetas: ['Buseta', 'TLS'],
      ),
      const InfoDispositivo(
        nombre: 'Bus-02', tipo: 'server',
        ruta: 'Ruta 10', activo: true, alertas: 3,
        etiquetas: ['PostgreSQL', 'Primary'],
      ),
      const InfoDispositivo(
        nombre: 'backup-srv', tipo: 'server',
        ruta: '10.0.3.5', activo: false, alertas: 0,
